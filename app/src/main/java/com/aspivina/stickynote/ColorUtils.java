...
public class ColorUtils {
    ...
    public static int getViewHolderBackgroundColorFromInstance_Blue(Context context, int instanceNum, boolean flag ) {
        if(flag) {
            switch (instanceNum % 2) {
                case 0:
                    return ContextCompat.getColor(context, R.color.material100Blue);
                case 1:
                    return ContextCompat.getColor(context, R.color.material750Blue);

                default:
                    return Color.WHITE;
            }
        }else{
            return ContextCompat.getColor(context, R.color.material300Yellow);
        }
